...
public class MainActivity extends AppCompatActivity implements BLEListener {
    ...
    private final String TARGET_DEVICE_NAME = "Lab3";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRedSeekBar = findViewById(R.id.seekBarRed);
        mGreenSeekBar = findViewById(R.id.seekBarGreen);
        mBlueSeekBar = findViewById(R.id.seekBarBlue);
        ...
        SeekBar.OnSeekBarChangeListener colorSeekBarListener = getColorSeekBarListener();
        mRedSeekBar.setEnabled(true);
        mRedSeekBar.setOnSeekBarChangeListener(colorSeekBarListener);
        mGreenSeekBar.setEnabled(true);
        mGreenSeekBar.setOnSeekBarChangeListener(colorSeekBarListener);
        mBlueSeekBar.setEnabled(true);
        mBlueSeekBar.setOnSeekBarChangeListener(colorSeekBarListener);
    ...
    private SeekBar.OnSeekBarChangeListener getColorSeekBarListener() {
    ...
    private void sendColorsToLed() {
        byte[] buf = new byte[] { (byte) 0x0F, (byte) 0x00, (byte) 0x00, (byte) 0x00 };
        buf[1] = (byte) mRedSeekBar.getProgress();
        buf[2] = (byte) mGreenSeekBar.getProgress();
        buf[3] = (byte) mBlueSeekBar.getProgress();
